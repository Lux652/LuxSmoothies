<template>
    <div class="add-smoothie container">
        <h2 class="center-align indigo-text">Dodaj novi smutač!</h2>
        <form @submit.prevent="AddSmoothie()">
            ...
            <div class="field" v-for="(ing, index) in ingredients" :key="index">
                <label for="ingredient">Sastojak(pritisnite TAB za dodavanje novog sastojka):</label>
            ...
            <div class="field center-align">
                ...
                <button class="btn pink">Dodaj smoothie</button>
            </div>
        </form>
    </div>
</template>
